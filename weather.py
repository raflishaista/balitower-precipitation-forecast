...
def main():
    ...
    for name, df in all_dfs.items():
        ...
        export_to_excel(df, f"outputs/{safe_name}_weather_{years}y.xlsx", name, years)
    ...
    if all_summaries:
        ...
        sum_wb.save("outputs/weather_summary.xlsx")
        print("  [Saved] outputs/weather_summary.xlsx")
